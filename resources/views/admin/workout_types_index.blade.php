    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        <div class="bg-white shadow-md rounded-lg p-6">
            <div class="mb-6 border-b border-gray-200 pb-4">
                <h2 class="text-2xl font-semibold text-gray-800">Workout Types</h2>
            </div>
            ...
            <!-- Form to add new workout type -->
            <div class="mb-10">
                <div class="bg-gray-50 rounded-lg shadow p-6 max-w-xl">
                    <h3 class="text-xl font-semibold mb-4 text-gray-700">Add New Workout Type</h3>
                    <form action="{{ route('admin.workout-types.store') }}" method="POST" class="space-y-4">
                        @csrf
                        <div>
            ...
            <!-- List of existing workout types -->
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 border text-sm text-left">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-gray-500">No workout types found</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
